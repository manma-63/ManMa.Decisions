import { c as createLucideIcon, j as jsxRuntimeExports, S as Slot, d as cn, f as cva } from "./index-Cx9npM13.js";
/**
...
function isVoteOpen(status) {
  return "#open" in status;
}
function isVoteClosed(status) {
  return "#closed" in status;
}
function hasVotedYes(choice) {
  return choice !== void 0 && "#yes" in choice;
}
function hasVotedNo(choice) {
  return choice !== void 0 && "#no" in choice;
}
export {
  ArrowLeft as A,
  Badge as B,
